...
<body>
  ...
  <div class="container">
    ...
    <div class="registration-section">
      ...
      <form method ="POST" action="{{ route('employee.store') }}">
        @csrf
         <div class="input-group">
          <select  class="input-field" name="school_id" id="school_id" required placeholder="School ID" value={{ old('school_id') }}>
        ...
        <div class="input-group">
          <input type="text" class="input-field" name="employee_id" required placeholder="Employee ID"  value={{ old('employee_id') }}>
      ...
      <p class="text-link">Already have an account? <a href="{{ route('employee.login') }}" class="sign-in">Login</a></p>
    </div>
  </div>
