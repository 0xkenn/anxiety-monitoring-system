...
@section('content')
    <div class="container mt-4" style="margin-left: 250px;"> <!-- Adjust the margin-left to fit your sidebar -->
        ...
        <div class="text-right" style="margin-right: 20px;"> 
            <a href="{{ route('employee.assessment') }}" class="btn btn-primary" style="margin-left: 20px;">Back to Assessment</a> <!-- Add margin-left for spacing -->
        </div>
    </div>
@endsection
