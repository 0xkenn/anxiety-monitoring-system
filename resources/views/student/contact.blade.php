...
@section('content')
<div class="contact-container" style="background-color: #fff; padding: 40px; border-radius: 20px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.1); width: 100%; max-width: 900px; display: flex; justify-content: space-between; align-items: center; margin-left: 180px; margin-top: 120px;"> <!-- Set margin-left to 150px -->
