...
@section('content')
  ...
  <div class="container" style="margin: 80px auto; width: 100%; margin-left: 70px;">
    <h4 style="text-align: center; margin-top: 50px; margin-bottom: 60px; margin-right: 170px;">Assessment Test</h4>
    
    <div style="margin-bottom: 20px;">
      <h6 class="value hide-in-result" style="display: none;">Score Value (0-22=Low) (23-42=Moderate) (43-63=Severe)</h6>
    </div>
    ...
    <form id="myForm" method="POST" action="{{ route('student.assessment.store') }}">
    @csrf
